...
function TotalStoreSalesBySupplier() {
    const dataTable = [];
    const columns = [
        { name: 'No.', selector: (row) => row.groupCode, sortable: true, width: '60px' },
        { name: 'Supplier', selector: (row) => row.groupName, sortable: true, width: '300px' },
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.TOTAL_STORE_SALES_BY_SUPPLIER.Visiblename}>
            {/* form */}
...
export default TotalStoreSalesBySupplier;
