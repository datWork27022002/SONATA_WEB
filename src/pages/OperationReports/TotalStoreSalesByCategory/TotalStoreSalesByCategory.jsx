...
function TotalStoreSalesByCategory() {
    const dataTable = [];
    const columns = [
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.TOTAL_STORE_SALES_BY_CATEGORY.Visiblename}>
            {/* form */}
...
export default TotalStoreSalesByCategory;
