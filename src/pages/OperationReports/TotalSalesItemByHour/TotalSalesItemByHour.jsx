...
function TotalSalesItemByHour() {
    const dataTable = [];
    const columns = [
        { name: 'No.', selector: (row) => row.groupCode, sortable: true, width: '60px' },
        { name: 'Hour', selector: (row) => row.groupName, sortable: true, width: '300px' },
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.TOTAL_SALES_ITEM_BY_HOUR.Visiblename}>
            {/* form */}
...
export default TotalSalesItemByHour;
