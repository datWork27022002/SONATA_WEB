...
function TotalSalesSummaryByItem() {
    const dataTable = [];
    const columns = [
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.TOTAL_SALES_SUMMARY_BY_ITEM.Visiblename}>
            {/* form */}
...
export default TotalSalesSummaryByItem;
