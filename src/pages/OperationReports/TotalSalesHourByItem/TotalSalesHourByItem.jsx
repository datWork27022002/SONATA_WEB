...
function TotalSalesHourByItem() {
    ...
    const dataTable2 = [];
    const columns2 = [
        { name: 'Hour', selector: (row) => row.groupName, sortable: true, width: '100px' },
        { name: 'Quantity', selector: (row) => row.groupName, sortable: true, width: '100px' },
        { name: 'Amount', selector: (row) => row.groupName, sortable: true },
    ];
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.TOTAL_SALES_HOUR_BY_ITEM.Visiblename}>
            {/* form */}
...
export default TotalSalesHourByItem;
