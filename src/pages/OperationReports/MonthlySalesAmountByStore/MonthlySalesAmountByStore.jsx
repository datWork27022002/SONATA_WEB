...
function MonthlySalesAmountByStore() {
    const [selectedRow, setSelectedRow] = useState(null);

    const dataTable = [];

    const columns = [
        { name: 'Month', selector: (row) => row.groupCode, sortable: true, width: '120px' },
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.MONTHLY_SALES_AMOUNT_BY_STORE.Visiblename}>
            {/* form */}
...
export default MonthlySalesAmountByStore;
