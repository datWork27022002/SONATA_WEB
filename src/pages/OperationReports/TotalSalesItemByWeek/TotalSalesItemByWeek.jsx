...
function TotalSalesItemByWeek() {
    const dataTable = [];
    const columns = [
        { name: 'No.', selector: (row) => row.groupCode, sortable: true, width: '60px' },
        { name: 'Item Name', selector: (row) => row.groupName, sortable: true, width: '300px' },
    ...
    const dataTable2 = [];
    const columns2 = [
        { name: 'Item Name', selector: (row) => row.groupName, sortable: true, width: '200px' },
        { name: 'Quantity', selector: (row) => row.groupName, sortable: true, width: '100px' },
        { name: 'Amount', selector: (row) => row.groupName, sortable: true },
    ];
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.TOTAL_SALES_ITEM_BY_WEEK.Visiblename}>
            {/* form */}
...
export default TotalSalesItemByWeek;
