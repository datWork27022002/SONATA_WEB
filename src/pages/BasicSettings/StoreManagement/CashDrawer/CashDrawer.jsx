...
import styles from './CashDrawer.module.scss';
...
function CashDrawer() {
    ...
    const dataTable = [{ cashDrawer: '돈통' }, { cashDrawer: '돈통' }, { cashDrawer: 'Cash Drawer' }];

    const columns = [{ name: 'Cash Drawer', selector: (row) => row.cashDrawer, sortable: true }];
