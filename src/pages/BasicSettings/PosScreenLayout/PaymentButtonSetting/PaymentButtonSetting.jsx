...
import styles from './PaymentButtonSetting.module.scss';
...
function PaymentButtonSetting() {
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.PAYMENT_BUTTON_SETTING.Visiblename}>
...
export default PaymentButtonSetting;
