...
export const listFuntionSetting = [
    { id: 1, name: 'Dine-in', icon: FaPlateWheat, disable: true },
    { id: 2, name: 'Quick Serve', icon: MdRoomService, disable: false },
    { id: 3, name: 'Receipt Management', icon: FaReceipt, disable: true },
    { id: 4, name: 'Search Order', icon: FaMessage, disable: true },
    { id: 5, name: 'Cashier In', icon: FaAnglesLeft, disable: false },
    { id: 6, name: 'Cashier Out', icon: FaAnglesRight, disable: false },
    { id: 7, name: 'Pay In', icon: FaArrowLeft, disable: true },
    { id: 8, name: 'Pay Out', icon: FaArrowRight, disable: true },
    ...
    { id: 14, name: 'ASP', icon: MdOutlineStackedLineChart, disable: true },
    { id: 15, name: 'Sales Report', icon: FaChartPie, disable: true },
    { id: 16, name: 'Restart The Program', icon: RiMiniProgramFill, disable: true },
    { id: 17, name: 'RF Order', icon: FaWifi, disable: true },
