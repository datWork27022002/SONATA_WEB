...
function SalesRecordByEmployeeDate() {
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.SALES_RECORD_BY_EMPLOYEE_DATE.Visiblename}>
            {/* form */}
...
export default SalesRecordByEmployeeDate;
