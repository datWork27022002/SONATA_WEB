...
function SalesReportByCardType() {
    const [selectedRow, setSelectedRow] = useState(null);

    const dataTable = [];

    const columns = [
        { name: 'Card Type', selector: (row) => row.groupName, sortable: true, width: '150px' },
        ...
        { name: 'Percents(%)', selector: (row) => row.groupName, sortable: true, width: '120px' },
    ...
    return (
        <TitleLayout title={config.nameMap.itemLevel3.SALES_REPORT_BY_CARD_TYPE.Visiblename}>
            {/* form */}
...
export default SalesReportByCardType;
