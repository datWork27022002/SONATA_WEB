...
function SimplifiedSalesTotal() {
    ...
    const columns = [
        ...
        { name: 'Item Quantity', selector: (row) => row.groupName, sortable: true, width: '120px' },
        ...
        { name: 'Total Sales', selector: (row) => row.groupName, sortable: true },
    ];

    const data = dataTable.map((value, index) => ({ ...value, id: index + 1 }));

    return (
        <TitleLayout title={config.nameMap.itemLevel3.SIMPLIFIED_SALES_TOTAL.Visiblename}>
            {/* form */}
...
export default SimplifiedSalesTotal;
