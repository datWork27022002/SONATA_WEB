const nameMap = {
    ...
    itemLevel2: {
        ...
        VOIDRETURN: { pathKey: '#2', Visiblename: 'Void/Return' },
        DISCOUNTSTATUS: { pathKey: '#3', Visiblename: 'Discount Status' },
        ...
        STORE: { pathKey: '#0', Visiblename: 'Store' },
        POS: { pathKey: '#1', Visiblename: 'POS' },
        OPTIONSETTING: { pathKey: '#2', Visiblename: 'Option setting' },
        PRINTOPTIONS: { pathKey: '#3', Visiblename: 'Print Options' },
        SECURITY: { pathKey: '#4', Visiblename: 'Security' },
        NETWORKSERVER: { pathKey: '#5', Visiblename: 'Network Server' },
    },
    itemLevel3: {
