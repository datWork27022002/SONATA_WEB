...
import { ItemRecipeManagement, ItemRecipeManager } from '~/pages/BasicSettings';
...
export const publicRoute = [
    ...
    { path: routes.BasicSettings.ITEM_RECEIPT_MANAGER, component: ItemRecipeManager, layout: BreadcrumbLayout },
